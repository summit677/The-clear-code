...
T_OSEK_MESSAGE_ControlBlock osekMsg_MessageTable[2];
...
#line 94 "OSEKos\\osekMessage.c"

    }
}


#line 171 "OSEKos\\osekMessage.c"
...
StatusType SendMessage(MsgType msg, AccessNameRef data)
{
	...
	i = 0;
	while( (i < 2) && (msg != &(osekMsg_MessageTable[i])) )
	{
		i++;
	}
    ...
    if (msg_LockMessage( msg ) != ( (StatusType)0 ) )
    {
        OSEK_TARGET_EnableOSInt(osIntSave);
		return ( (StatusType)(4 + 32) );
    }
...
#line 282 "OSEKos\\osekMessage.c"

    
    ((msg)->messageStatus &= ((OSBYTE)~0x01));
    ...
    if ((msg_SignalMessage( msg ) == ((StatusType)0xFF))        
...
#line 426 "OSEKos\\osekMessage.c"

    ((msg)->messageStatus &= ((OSBYTE)~0x01));

#line 436 "OSEKos\\osekMessage.c"
...
#line 472 "OSEKos\\osekMessage.c"

#line 481 "OSEKos\\osekMessage.c"
...
StatusType msg_LockMessage( MsgType msg )
{
    ...
    if ((msg->messageStatus & (0x01 )) != 0 )
    {
        return ( (StatusType)(4 + 32) );
    }

    
    msg->messageStatus |= 0x01;

    return ( (StatusType)0 );
}


#line 636 "OSEKos\\osekMessage.c"


#line 677 "OSEKos\\osekMessage.c"
...
StatusType StopCOM(OSBYTE ShutdownMode)
{
    ...
    for( i = 0; i < 2; i++ )
    {
        if( (osekMsg_MessageTable[i].messageStatus & ( 0x02 | 0x01 )) != 0 )
        {
			return ( (StatusType)(1 + 32) );
        }
    }
