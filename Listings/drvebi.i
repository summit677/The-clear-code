...
#line 8 "Drivers\\src\\DrvEBI.c"
#line 1 ".\\Drivers\\inc\\DrvGPIO.h"
...
#line 117 ".\\Drivers\\inc\\DrvGPIO.h"
...
#line 9 "Drivers\\src\\DrvEBI.c"
#line 1 ".\\Drivers\\inc\\DrvEBI.h"
...
int32_t DrvEBI_Open(DRVEBI_CONFIG_T sEBIConfig)
{
	...
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->AHBCLK.EBI_EN = 1;

	 
	((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EBICON.ExtEN = 1;
	...
	{
        return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVEBI) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((1) & 0x7F));
	}
    ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EBICON.ExtBW16 = sEBIConfig.eDataWidth;
...
void DrvEBI_Close(void)
{
	...
	((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EBICON.ExtEN = 0;
	
	 
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->AHBCLK.EBI_EN = 0;
...
void DrvEBI_SetBusTiming(DRVEBI_TIMING_T sEBITiming)
{	
	((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EBICON.MCLKDIV = sEBITiming.eMCLKDIV;
	((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EBICON.ExttALE = sEBITiming.u8ExttALE;
	
	((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EXTIME.ExttACC = sEBITiming.u8ExttACC;
	((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EXTIME.ExttAHD = sEBITiming.u8ExttAHD;
	((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EXTIME.ExtIW2X = sEBITiming.u8ExtIW2X;
	((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EXTIME.ExtIR2R = sEBITiming.u8ExtIR2R;
}
...
void DrvEBI_GetBusTiming(DRVEBI_TIMING_T *psEBITiming)
{
	psEBITiming->eMCLKDIV  = (E_DRVEBI_MCLKDIV)((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EBICON.MCLKDIV;
	psEBITiming->u8ExttALE = ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EBICON.ExttALE;
	
	psEBITiming->u8ExttACC = ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EXTIME.ExttACC;
	psEBITiming->u8ExttAHD = ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EXTIME.ExttAHD;
	psEBITiming->u8ExtIW2X = ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EXTIME.ExtIW2X;
	psEBITiming->u8ExtIR2R = ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EXTIME.ExtIR2R;
}
