...
#line 8 "Drivers\\src\\DrvPS2.c"

 
 
 
#line 1 ".\\Drivers\\inc\\DrvPS2.h"
...
static PFN_DRVPS2_CALLBACK *g_pfnPS2callback = 0;
...
int32_t DrvPS2_Open(void)
{
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.PS2_RST = 1;
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.PS2_RST = 0;

    ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.PS2_EN = 1;

    (((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON . PS2EN = 1);  
    (((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON . TXFIFO_DEPTH = (1-1));
    
    ((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON . CLRFIFO = 1; ((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON . CLRFIFO = 0;
...
void DrvPS2_Close()
{
	((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON.PS2EN = 0;
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.PS2_EN = 0;
	
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.PS2_RST = 1;
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.PS2_RST = 0;
    
    ((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON.TXFIFO_DEPTH = 0;
}
...
void PS2_IRQHandler(void)
{
    ...
    u32IntStatus = ((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->u32INTID;
    ((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->u32INTID = 3;
    if(g_pfnPS2callback != 0)
    {
...
)
{
	...
	((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON.TXINTEN = (u32InterruptFlag & 0x00000002)?1:0;
	((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON.RXINTEN = (u32InterruptFlag & 0x00000001)?1:0;

	g_pfnPS2callback = pfncallback;
	
	NVIC_SetPriority (PS2_IRQn, (1<<2) - 2);
...
{
	uint32_t u32Reg = *((uint32_t *)&(((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON));
	return (u32Reg &
		 (u32InterruptFlag & (0x00000001 | 0x00000002)));
}
...
{
	if(u32InterruptFlag & 0x00000002)
		(((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON . TXINTEN = 0);
	if(u32InterruptFlag & 0x00000001)
		(((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON . RXINTEN = 0);
...
)
{
	...
	if((u32InterruptFlag & 0x00000001) == 0x00000001)	   
		(((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->u32INTID = (1));

	if((u32InterruptFlag & 0x00000002) == 0x00000002)
		(((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->u32INTID = (2));
...
{	
	...
	{
		case 0x00000001:
			if(((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->u32INTID & 0x00000001)		  	
				return 1;
			break;
		case 0x00000002:
			if(((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->u32INTID & 0x00000002)		    
				return 1;
			break;
		default:
			break;
...
{
	(((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON . TXFIFO_DEPTH = (u32TxFIFODepth-1));
}
...
{   
	*pu8RxBuf = (((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->RXDATA);
...
)
{
    ...
    txcnt = u32WriteBytes/16;
    remainder = u32WriteBytes % 16;
    if(remainder)
    	txcnt++;
    if(u32WriteBytes >= 16)
    {
    	(((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON . TXFIFO_DEPTH = (16-1));
    }
    else
    {
    	(((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON . TXFIFO_DEPTH = (u32WriteBytes-1));
    }
	
	do
	{
		u32delayno = 0;
		while ((((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->STATUS . TXEMPTY) != 1)
		{
			u32delayno++;
			if ( u32delayno >= 0x40000000 )     	    
				return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVPS2) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((1) & 0x7F));     	       
		}
		((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->TXDATA[0]=(pu32TxBuf[i++]);
		((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->TXDATA[1]=(pu32TxBuf[i++]);
		((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->TXDATA[2]=(pu32TxBuf[i++]);
		((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->TXDATA[3]=(pu32TxBuf[i++]);
