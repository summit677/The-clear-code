...
#line 15 "Drivers\\src\\DrvRTC.c"
#line 1 ".\\Drivers\\inc\\DrvRTC.h"
...
{   
	if (((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->RIIR.TIF == 0x1)      		         
	{
        *((volatile unsigned int *)(&((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->RIIR))=0x2;  
    ...
    if (((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->RIIR.AIF == 0x1)                    
    {
        *((volatile unsigned int *)(&((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->RIIR))=0x1;  
...
int32_t DrvRTC_Open(S_DRVRTC_TIME_DATA_T *sPt)
{
    ...
    {
        DrvRTC_WriteEnable();
 		((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->TSSR.HR24_HR12 = 0;
...
int32_t DrvRTC_Read(E_DRVRTC_TIME_SELECT eTime, S_DRVRTC_TIME_DATA_T *sPt)
{
    ...
    sPt->u8cClockDisplay = ((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->TSSR.HR24_HR12;      
...
int32_t DrvRTC_EnableInt(E_DRVRTC_INT_SOURCE str_IntSrc, PFN_DRVRTC_CALLBACK pfncallback)
{
    ...
    NVIC_SetPriority(RTC_IRQn, (1<<2) - 2);
