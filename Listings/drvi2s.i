...
#line 7 "Drivers\\src\\DrvI2S.c"
#line 1 ".\\Drivers\\inc\\DrvI2S.h"
...
#line 8 "Drivers\\src\\DrvI2S.c"
#line 1 ".\\Drivers\\inc\\DrvSYS.h"
...
void I2S_IRQHandler(void)
{
    ...
    u32Reg = (*((volatile unsigned int *)(&(((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SSTATUS))));

    if (u32Reg & 0x00000004)
    {
         
        if ((u32Reg & 0x00010000) && (((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SIE.TXUDFIE == 1))
        {
            if (I2SHandler.TxUnderflowFn)
                I2SHandler.TxUnderflowFn(u32Reg);
            
            *((volatile unsigned int *)(&(((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SSTATUS)))=0x00010000;
        }
         
        else if ((u32Reg & 0x00020000) && (((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SIE.TXOVFIE == 1))
        {
            if (I2SHandler.TxOverflowFn)
                I2SHandler.TxOverflowFn(u32Reg);
            
            *((volatile unsigned int *)(&(((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SSTATUS)))=0x00020000; 
        }
         
        else if ((u32Reg & 0x00400000) && (((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SIE.RZCIE == 1))
        {
            if (I2SHandler.TxRightZeroCrossFn)
                I2SHandler.TxRightZeroCrossFn(u32Reg);
            *((volatile unsigned int *)(&(((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SSTATUS)))=0x00400000;   
        }
         
        else if ((u32Reg & 0x00800000) && (((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SIE.LZCIE == 1))
        {
            if (I2SHandler.TxLeftZeroCrossFn)
                I2SHandler.TxLeftZeroCrossFn(u32Reg);
            *((volatile unsigned int *)(&(((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SSTATUS)))=0x00800000;   
        }   
         
        else if (((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SIE.TXTHIE == 1)
        {
            if (I2SHandler.TxFifoThresholdFn)
                I2SHandler.TxFifoThresholdFn(u32Reg);  
        }
    }
    else if (u32Reg & 0x00000002)
    {
         
        if ((u32Reg & 0x00000100) && (((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SIE.RXUDFIE == 1))
        {
            if (I2SHandler.RxUnderflowFn)
                I2SHandler.RxUnderflowFn(u32Reg);
            
            *((volatile unsigned int *)(&(((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SSTATUS)))=0x00000100;  
        }
         
        else if ((u32Reg & 0x00000200) && (((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SIE.RXOVFIE == 1))
        {
            if (I2SHandler.RxOverflowFn)
                I2SHandler.RxOverflowFn(u32Reg);

            *((volatile unsigned int *)(&(((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SSTATUS)))=0x00000200;    
        }
         
        else if (((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SIE.RXTHIE == 1)
        {
...
int32_t DrvI2S_Open(S_DRVI2S_DATA_T *sParam)
{
    ...
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2S_RST = 1;
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2S_RST = 0;

    ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.I2S_EN = 1;
    
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.WORDWIDTH  = sParam->u8WordWidth;
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.MONO       = sParam->u8AudioFormat;
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.FORMAT     = sParam->u8DataFormat;
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.SLAVE      = sParam->u8Mode;
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.TXTH       = sParam->u8TxFIFOThreshold;
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.RXTH       = sParam->u8RxFIFOThreshold - 1;
    ...
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCLKDIV.BCLK_DIV = u8Divider;   
    
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.I2SEN = 1; 
...
void DrvI2S_Close(void)
{
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.I2SEN = 0;
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2S_RST = 1;
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2S_RST = 0;
    ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.I2S_EN = 0;
}
...
int32_t DrvI2S_EnableInt(E_I2S_CALLBACK_TYPE Type, I2S_CALLBACK callbackfn)
{
    switch (Type)
    {
        ...
        default:
            return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVI2S) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((1) & 0x7F));       
    }
        
    *((volatile unsigned int *)(&(((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SIE)))=(*((volatile unsigned int *)(&(((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SIE)))) | (1<<Type);    
    NVIC_SetPriority(I2S_IRQn, (1<<2) - 2);
...
{   
    *((volatile unsigned int *)(&(((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SIE)))=(*((volatile unsigned int *)(&(((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SIE)))) & ~(1<<Type);
    ...
    switch(Type)
    {
        case I2S_RX_UNDERFLOW:
        {
            I2SHandler.RxUnderflowFn = 0;  
            break;
        }
        case I2S_RX_OVERFLOW:
        {
            I2SHandler.RxOverflowFn = 0; 
            break;
        }
        case I2S_RX_FIFO_THRESHOLD:
        {
            I2SHandler.RxFifoThresholdFn = 0;  
            break;
        }        
        case I2S_TX_UNDERFLOW:
        {
            I2SHandler.TxUnderflowFn = 0;  
            break;
        }
        case I2S_TX_OVERFLOW:
        {
            I2SHandler.TxOverflowFn = 0;  
            break;
        }
        case I2S_TX_FIFO_THRESHOLD:
        {
            I2SHandler.TxFifoThresholdFn = 0;  
            break;
        }
        case I2S_TX_RIGHT_ZERO_CROSS:
        {
            I2SHandler.TxRightZeroCrossFn = 0; 
            break;
        }
        case I2S_TX_LEFT_ZERO_CROSS:
        {
            I2SHandler.TxLeftZeroCrossFn = 0; 
            break;
        }        
        default:
            return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVI2S) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((1) & 0x7F));    
...
uint32_t DrvI2S_GetBCLKFreq(void)
{
    ...
    u32Reg = ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCLKDIV.BCLK_DIV;
...
uint32_t DrvI2S_GetMCLKFreq(void)
{
    ...
    u32Reg = ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCLKDIV.MCLK_DIV;
...
void DrvI2S_SetMCLKFreq(uint32_t u32Mclk)
{
    ...
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCLKDIV.MCLK_DIV = u8Divider;
}
...
int32_t DrvI2S_SetChannelZeroCrossDetect(E_I2S_CHANNEL channel, int32_t i32flag)
{
    ...
    {
        ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.LCHZCEN = i32flag;
    }
    else if (channel == I2S_RIGHT_CHANNEL)
    {
        ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.RCHZCEN = i32flag;
    }
    else
        return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVI2S) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((1) & 0x7F));
...
void DrvI2S_EnableTxDMA(void)
{   
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.TXDMA = 1;
}
...
void DrvI2S_DisableTxDMA(void)
{   
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.TXDMA = 0;
}
...
void DrvI2S_EnableRxDMA(void)
{
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.RXDMA = 1; 
}
...
void DrvI2S_DisableRxDMA(void)
{
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.RXDMA = 0; 
}
...
void DrvI2S_EnableTx(void)
{
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.TXEN = 1;
}
...
void DrvI2S_DisableTx(void)
{
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.TXEN = 0;
}
...
void DrvI2S_EnableRx(void)
{
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.RXEN = 1;  
}
...
void DrvI2S_DisableRx(void)
{
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.RXEN = 0;
}
...
void DrvI2S_EnableTxMute(void)
{
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.MUTE = 1;  
}
...
void DrvI2S_DisableTxMute(void)
{
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.MUTE = 0;  
}
...
void DrvI2S_EnableMCLK(void)
{   
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.MCLKEN = 1;
}
...
void DrvI2S_DisableMCLK(void)
{   
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.MCLKEN = 0;
}
...
void DrvI2S_ClearTxFIFO(void)
{
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.CLR_TXFIFO = 1;
}
...
void DrvI2S_ClearRxFIFO(void)
{
    ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SCON.CLR_RXFIFO = 1;
}
...
{
    uint8_t  u8ClkSrcSel;
    uint32_t u32Freq = (12000000UL);
     
    
    u8ClkSrcSel = ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL2.I2S_S;
