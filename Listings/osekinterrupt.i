...
#line 25 "OSEKos\\osekInterrupt.c"
...
#line 26 "OSEKos\\osekInterrupt.c"
...
void osekInterrupt_Initialize(void)
{
	osekInterrupt_IsrStackTop = (OSDWORD)isr2Stack + (OSDWORD)(1024 - 0x20);
}
