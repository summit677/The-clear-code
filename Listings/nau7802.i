#line 1 "NUC1xx-LB_002\\src\\NAU7802.c"
...
#line 7 "NUC1xx-LB_002\\src\\NAU7802.c"
...
#line 8 "NUC1xx-LB_002\\src\\NAU7802.c"
#line 1 ".\\Drivers\\inc\\DrvI2C.h"
...
#line 9 "NUC1xx-LB_002\\src\\NAU7802.c"
...
#line 10 "NUC1xx-LB_002\\src\\NAU7802.c"
#line 1 ".\\NUC1xx-LB_002\\inc\\NAU7802.h"
...
#line 11 "NUC1xx-LB_002\\src\\NAU7802.c"
...
void I2C0_Callback_NAU7802(uint32_t status)
{
	...
	{
		case 0x08: 	    
			DrvI2C_WriteData(I2C_PORT0, 0x54);
			DrvI2C_Ctrl(I2C_PORT0, 0, 0, 1, 0);
			DataLen=0;
			break;

		case 0x18: 	   	 
			DrvI2C_WriteData(I2C_PORT0, Register_Addr);
			DrvI2C_Ctrl(I2C_PORT0, 0, 0, 1, 0);
			break;
		...
		case 0x28: 	   	 
			if(EndFlag&0x80)
			{
				...
				{
					DrvI2C_WriteData(I2C_PORT0, pu8Data[DataLen++]);
					DrvI2C_Ctrl(I2C_PORT0, 0, 0, 1, 0);
				}
				else
				{
		...
		case 0x10: 	   	 
			DrvI2C_WriteData(I2C_PORT0, 0x55);
			DrvI2C_Ctrl(I2C_PORT0, 0, 0, 1, 0);
			break;
		...
		case 0x50: 	   	 
			pu8Data[DataLen++] = DrvI2C_ReadData(I2C_PORT0);
...
void InitNAU7802(void)
{
	...
	DrvI2C_InstallCallback(I2C_PORT0, I2CFUNC, I2C0_Callback_NAU7802);
