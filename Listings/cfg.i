...
#line 10 "OSEKos\\cfg.c"
#line 11 "OSEKos\\cfg.c"
#line 1 ".\\Drivers\\inc\\DrvTIMER.h"
...
#line 10 ".\\Drivers\\inc\\DrvTIMER.h"
...
#line 32 ".\\Drivers\\inc\\DrvTIMER.h"
...
#line 12 "OSEKos\\cfg.c"

 



OSBYTE	taskStack[5][120]; 
OSBYTE	messageBuf[2][30];			 
OSBYTE	messageQueue[2][30];			 


 


void Ir_RealTimInt(void)
{
	 CounterTrigger(0);
}
...
OSBYTE	osekConfig_InterruptTypeTable[128] = 
{
		2,
		2,
		2,
...
T_OSEK_TASK_Entry	osekConfig_InterruptEntryTable[128] = 
{
...
T_OSEK_COUNTER_ConfigTable osekConfig_CounterTable[1] = 
{
	{
		32767,	
		1,
...
unsigned char		osekMsg_Msg4Object;



const	T_OSEK_MESSAGE_ConfigTable	osekConfig_MsgTable[2]=
{
	{
		0,
		&osekMsg_Msg1Object,
